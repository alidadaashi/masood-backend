...
import MdI18nInstance from "../../i18n/i18nInstance/mdI18nInstance";
...
class SrLanguages {
  static async getAllLanguages(
    ...
    let selectedUserInstances:string[] = [];
    if (sessionUser) selectedUserInstances = utGetSelectedInstanceIds(sessionUser?.userInstances);
    return srGetAllLanguages(trx, selectedUserInstances);
  }
